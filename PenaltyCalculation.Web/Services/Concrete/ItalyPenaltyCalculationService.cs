...
{
    public class ItalyPenaltyCalculationService:IPenaltyCalculationService
    {
        private readonly decimal PenaltyForEachDayPrice = 1.63m;
        ...
        public int GetBusinessDays(PenaltyInputModel inputModel)
        {
            ...
            for (var date = inputModel.From; date <= inputModel.To; date = date.AddDays(0))
            {
